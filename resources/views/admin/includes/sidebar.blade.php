<aside class="main-sidebar elevation-4 sidebar-dark-primary"  style="overflow-x: hidden;">
    ...
    <a href="index3.html" class="brand-link">
      <img src="{{ asset('storage/img/Blog.png') }}" alt="AdminLTE Logo" width="100" height="auto" class="brand-image img-circle elevation-3"
           style="opacity: .8">
         ...
         <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <a href="{{ route('users.show',Auth::user()->id )}}">
                    <img src="{{ asset('storage/' . Auth::user()->image ) }}" class="img-circle elevation-2 perfil-sidebar">
                </a>
            </div>
            <div class="info">
                <a href="{{ route('users.show',Auth::user()->id )}}" class="d-block">{{ Auth::user()->name ?? 'Usuário' }}</a>
            </div>
